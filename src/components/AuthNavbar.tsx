...
export default function AuthNavbar() {
    ...
    return (
        <nav className="w-full min-h-[94px] h-auto bg-[#FFFFFF] border-b border-gray-100 flex flex-wrap lg:flex-nowrap items-center justify-between px-4 py-4 lg:py-0 lg:px-[100px] relative font-sans">
            ...
            <div className="static lg:absolute lg:left-1/2 lg:transform lg:-translate-x-1/2 flex items-center justify-center gap-2 lg:gap-[16px] w-full lg:w-[512px] h-[50px] lg:h-[78px] order-3 lg:order-none mt-4 lg:mt-0">
                <Link
                    href="/dashboard"
                ...
                >
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="fill-current w-[16px] h-[16px] lg:w-[20px] lg:h-[20px]">
                ...
                >
                    <svg width="24" height="19" viewBox="0 0 29 23" fill="none" xmlns="http://www.w3.org/2000/svg" className="fill-current w-[16px] h-[16px] lg:w-[24px] lg:h-[19px]">
            ...
            <div className="flex-shrink-0 flex justify-end order-2 lg:order-none">
                <Link 
                    href="/profile" 
